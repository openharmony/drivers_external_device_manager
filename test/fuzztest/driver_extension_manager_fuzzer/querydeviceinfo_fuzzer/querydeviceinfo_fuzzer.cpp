...
bool QueryDeviceInfoFuzzTest(const uint8_t *rawData, size_t size)
{
    ...
    int32_t code = static_cast<uint32_t>(DriverExtMgrInterfaceCode::QUERY_DEVICE_INFO);
...
{
    OHOS::ExternalDeviceManager::QueryDeviceInfoFuzzTest(data, size);
    return 0;
}