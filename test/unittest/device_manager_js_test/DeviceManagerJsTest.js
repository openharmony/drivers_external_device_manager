...
describe("DeviceManagerJsTest", function () {
     ...
     * @tc.type: FUNC
     */
    it("DeviceManager_bindDriverWithDeviceId_001", 0, async function (done) {
        console.info('----------------------DeviceManager_bindDriverWithDeviceId_001---------------------------');
        try {
     ...
     * @tc.type: FUNC
     */
    it("DeviceManager_bindDriverWithDeviceId_002", 0, async function (done) {
        console.info('----------------------DeviceManager_bindDriverWithDeviceId_002---------------------------');
        try {
     ...
     * @tc.type: FUNC
     */
    it("DeviceManager_bindDriverWithDeviceId_005", 0, async function (done) {
        console.info('----------------------DeviceManager_bindDriverWithDeviceId_005---------------------------');
        try {
     ...
     * @tc.type: FUNC
     */
    it("DeviceManager_unbindDriverWithDeviceId_001", 0, async function (done) {
        console.info('----------------------DeviceManager_unbindDriverWithDeviceId_001---------------------------');
        try {
     ...
     * @tc.type: FUNC
     */
    it("DeviceManager_unbindDriverWithDeviceId_002", 0, async function (done) {
        console.info('----------------------DeviceManager_unbindDriverWithDeviceId_002---------------------------');
        try {
     ...
     * @tc.type: FUNC
     */
    it("DeviceManager_unbindDriverWithDeviceId_003", 0, async function (done) {
        console.info('----------------------DeviceManager_unbindDriverWithDeviceId_003---------------------------');
        try {
            if (deviceId == null) {
                console.log('Device ID has not been set.');
